...
// 32 MB: the sanctions-pressure seed writes a ~2-8 MB canonical payload
// (20k+ OFAC entries + entity index). Loopback-only service, so a generous
// cap is safe; 1 MB destroyed the socket mid-write (client saw ECONNRESET).
