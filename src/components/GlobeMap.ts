...
export class GlobeMap {
  ...
  private static readonly VIEW_POVS: Record<MapView, { lat: number; lng: number; altitude: number }> = {
    global:   { lat: 36,  lng:  127.8, altitude: 0.9 },
    kr_west:  { lat: 37.2, lng: 125.4, altitude: 0.5 },
    kr_south: { lat: 34.5, lng: 128.6, altitude: 0.5 },
    kr_jeju:  { lat: 33.3, lng: 126.5, altitude: 0.5 },
    kr_east:  { lat: 37.3, lng: 130.8, altitude: 0.6 },
