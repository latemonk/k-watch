...
// KCG fork: 국내 24시간 뉴스 채널 (인지도순). Handles verified live
// (curl 200) 2026-07-21; live video IDs are auto-detected from the handle
// via /api/youtube/live, with fallbackVideoId where a stable stream exists.
const FULL_LIVE_CHANNELS: LiveChannel[] = [
  { id: 'ytn', name: 'YTN', handle: '@ytnnews24', fallbackVideoId: 'aZyD6EPl6KU' },
  { id: 'yonhapnewstv', name: '연합뉴스TV', handle: '@yonhap', fallbackVideoId: '6QZ_qc75ihU' },
  { id: 'kbs-news', name: 'KBS 뉴스', handle: '@newskbs' },
  { id: 'mbc-news', name: 'MBC 뉴스', handle: '@MBCNEWS11', fallbackVideoId: 'q9bM12ucTIY' },
  { id: 'sbs-news', name: 'SBS 뉴스', handle: '@sbs8news' },
  { id: 'jtbc-news', name: 'JTBC 뉴스', handle: '@jtbcnews' },
  { id: 'channela-news', name: '채널A 뉴스', handle: '@ChannelA-News' },
  { id: 'tvchosun', name: 'TV조선', handle: '@tvchosun' },
  { id: 'mbn-news', name: 'MBN 뉴스', handle: '@MBNNews' },
];
