...
const KCG_POLITICS_FEEDS: Feed[] = [
  ...
  { name: '머니투데이', url: rss('http://rss.mt.co.kr/mt_news.xml') },
...
const KCG_INTEL_FEEDS: Feed[] = [
  ...
  { name: '한국해운신문', url: rss('http://www.maritimepress.co.kr/rss/allArticle.xml') },
  ...
  { name: '해양한국', url: rss('http://www.monthlymaritimekorea.com/rss/allArticle.xml') },
  { name: '한국수산경제', url: rss('http://www.fisheco.com/rss/allArticle.xml') },
...
export const INTEL_SOURCES: Feed[] = [
  ...
  { name: '한국해운신문', url: rss('http://www.maritimepress.co.kr/rss/allArticle.xml'), type: 'defense' },
