...
import type { ChokepointRegistryEntry } from '@/config/chokepoint-registry';
...
// KCG fork: the default zone set is the six Korean coastal-waters boxes
// (west sea / Jeju / Korea Strait / east sea). The relay captures ALL ship
// types inside the Korea bbox into tankerReports, so these queries return
// the full surface picture, not just tankers.
