 ...
 */
// KCG fork: single-tenant console — no Pro product, nothing is premium-gated.
// The original list is kept below (dead) for reference.
export const PREMIUM_RPC_PATHS = new Set<string>([]);
export const _UPSTREAM_PREMIUM_RPC_PATHS = new Set<string>([
