  ...
  const showToast = (): void => {
    ...
    setTrustedHtml(toast, trustedHtml(`
      ...
      <div class="update-toast-body">
        <div class="update-toast-title">\uc0c8 \ubc84\uc804\uc774 \uc900\ube44\ub410\uc5b4\uc694</div>
        <div class="update-toast-detail">\uc0c8\ub85c\uace0\uce68\ud558\uba74 \ucd5c\uc2e0 \ud654\uba74\uc73c\ub85c \ubc14\ub00c\uc5b4\uc694.</div>
      </div>
      <button class="update-toast-action" data-action="reload">\uc0c8\ub85c\uace0\uce68</button>
      <button class="update-toast-dismiss" data-action="dismiss" aria-label="\ub2eb\uae30">\u00d7</button>
